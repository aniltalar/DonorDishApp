...
fun SetupAccountActivityScreen() {
        ...
        Button(
            onClick = {
                when {
                    ...
                    donorConfirmPassword.isBlank() -> {
                        errorMessage = "Please confirm your password."
                    }
                     donorPassword != donorConfirmPassword -> {
 ...
 private fun saveDonorData(donorData: DonorData,context: Activity){
     ...
     val ref = db.getReference("Donors")

     ref.child(donorData.donorEmail.replace(".", ",")).setValue(donorData)
